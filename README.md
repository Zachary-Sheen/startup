...
- **JavaScript** - Pulls information from the CoinGecko API and implements a the ability to click a currency sends the user to the chat and further information for that currency.
